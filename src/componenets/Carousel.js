          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <div className="header10-textarea aos-init aos-animate" data-aos="zoom-out" data-aos-duration="1000">
                ...
                <p style={{ marginTop: "0px", marginBottom: '1rem', color: '#10886F', fontWeight: '600' }} className="font-ks font-16 weight-500 color opacity2 lineh-26">To emerge stronger when things start to recover, you need to identify opportunities that can move your business forward and work to distinguish yourself in your market.</p>
